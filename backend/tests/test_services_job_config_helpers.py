...
def test_idempotency_key_order_stable() -> None:
    ...
    k1 = compute_idempotency_key(
        ...
        train_ds="ds1", test_ds=None, predict_ds=None, source_model=None,
        params={"a": 1, "b": 2},
    )
...
def test_idempotency_key_differs_per_user() -> None:
    ...
    k_u1 = compute_idempotency_key(
        user_id="u1", detector_version_id="dv1", job_type="train",
        train_ds=None, test_ds=None, predict_ds=None, source_model=None, params={},
    )
    k_u2 = compute_idempotency_key(
        user_id="u2", detector_version_id="dv1", job_type="train",
        train_ds=None, test_ds=None, predict_ds=None, source_model=None, params={},
    )
    assert k_u1 != k_u2
...
def test_idempotency_key_differs_per_params() -> None:
    ...
    assert (
        compute_idempotency_key(**base, params={"lr": 0.1})
