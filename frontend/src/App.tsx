        ...
        children: [
          {
            index: true,
            lazy: async () => ({
              Component: (await import("./routes/_authed.detectors._index"))
                .default,
              handle: (await import("./routes/_authed.detectors._index"))
                .handle,
            }),
          },
          {
            path: "new",
            lazy: async () => ({
              Component: (await import("./routes/_authed.detectors.new"))
                .default,
          ...
          },
          {
            path: ":id",
            lazy: async () => ({
              Component: (await import("./routes/_authed.detectors.$id"))
                .default,
        ...
        children: [
          {
            index: true,
            lazy: async () => ({
              Component: (await import("./routes/_authed.datasets._index"))
                .default,
          ...
          },
          {
            path: "new",
            lazy: async () => ({
              Component: (await import("./routes/_authed.datasets.new"))
                .default,
          ...
          },
          {
            path: ":id",
            lazy: async () => ({
              Component: (await import("./routes/_authed.datasets.$id"))
                .default,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: ":expId/:runId",
            lazy: async () => ({
              Component: (await import("./routes/_authed.runs.$expId.$runId"))
                .default,
              handle: (await import("./routes/_authed.runs.$expId.$runId"))
                .handle,
            }),
          },
        ],
        ...
        children: [
          {
            index: true,
            lazy: async () => ({
              Component: (await import("./routes/_authed.models._index"))
                .default,
