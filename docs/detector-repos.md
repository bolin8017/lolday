...
| ------------------------------------ | -------------------------------------- | -------------------------- | ------------- | ------------ |
| `~/Documents/repositories/elfrfdet`  | https://github.com/bolin8017/elfrfdet  | sklearn (Random Forest)    | `3.0.0`       | `>=1.2,<2.0` |
| `~/Documents/repositories/elfcnndet` | https://github.com/bolin8017/elfcnndet | PyTorch Lightning (1D-CNN) | `3.0.0`       | `>=1.2,<2.0` |
